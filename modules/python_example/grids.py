...
###################################
# Following methods used to create#
# the grid map for the network to #
# learn from                      #
###################################
def randPair(s,e):
    return np.random.randint(s,e), np.random.randint(s,e)

#finds an array in the depth dimension of grid
...
'''
model = Sequential()
model.add(Dense(164, init='lecun_uniform', input_shape=(64,))) #input layer 64 units (4x4x4 numpy array), hidden layer 164 units
